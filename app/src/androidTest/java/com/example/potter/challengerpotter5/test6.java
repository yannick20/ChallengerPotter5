...
/**
 * Created by Potter on 28/03/2018.
 */
...
public class test6 {
    ...
    public void name() throws Exception {
        ...
        onView(withId(R.id.txt_mail)).perform(typeText("ghost@gmail.com")).toString();

        onView(withId(R.id.txt_pwd)).perform(typeText("ghost1234"));
